...
> documents the full system, its measured evaluation results, the remaining
> known limitations (see [Development roadmap](#development-roadmap),
> [Evaluation methodology](#evaluation-methodology) and
> [Known limitations](#known-limitations)), and a production-oriented
> **self-hosted Docker** workflow ([Self-hosted Docker](#self-hosted-docker)).
